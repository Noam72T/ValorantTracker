export const getAgentImage = (agentName: string): string => {
  ...
  return agents[agentName] || 'https://media.valorant-api.com/agents/add6443a-41bd-e414-f6ad-e58d267f4e95/displayicon.png';
};
...
export const getMapImage = (mapName: string): string => {
  ...
  return maps[mapName] || 'https://media.valorant-api.com/maps/7eaecc1b-4337-bbf6-6ab9-04b8f06b3319/splash.png';
};

export const getRankImage = (rankName: string): string => {
  ...
  return ranks[rankName] || 'https://media.valorant-api.com/competitivetiers/03621f52-342b-cf4e-4f86-9350a49c6d04/0/largeicon.png';
};
